...
I built a Data Ingestion Pipeline Using PyMuPDF and Regex to ingest and structure the 320 pages+ of legal documentation into a json file that can 
\subsection{Vector Database Implementation}
A persistent ChromaDB instance serves as the system's non-parametric memory, storing document chunks as high-dimensional vectors. Using the all-MiniLM-L6-v2 model, the database indexes 384-dimensional embeddings that allow for efficient similarity searches while maintaining a lightweight local storage footprint.
